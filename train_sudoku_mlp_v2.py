"""
Distilled Sudoku training using TRM model with MLP variant - no puzzle embeddings.

Usage:
    python train_sudoku_mlp_v2.py
"""
...
def train():
    ...
    model_config = {
        ...
        "puzzle_emb_ndim": 0,  # Disable puzzle embeddings entirely
        "H_cycles": 3,
        "L_cycles": 6,
        "H_layers": 0,
        "L_layers": 2,
    ...
    # Optimizer (single AdamW for all parameters)
